...
const indexTransactionByAmount = transactions.findIndex(transaction => transaction.amount === -30)
console.log('Index Transaction amount -30: ', indexTransactionByAmount)
